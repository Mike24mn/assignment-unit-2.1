...
let result; if (adventurous === true) {result = "Adventures are great!";
...
diceRoll; if (luckyNumber === 2 && adventurous === true) {console.log("Roll the dice!");
...
let petStatus = "I can have more pets" // pet status container/initial 
petStatus; if (pets < allowedPets) {console.log("I can have more pets");
...
mostPets; if (pets < friendsPets) {console.log(friendsPets);
  
}

if (pets > friendsPets) {console.log(pets);
  
}

else{console.log("You both have the same amount of pets my friend!");

}

console.log("You have " + mostPets + " pets my friend!");
console.log("Hello peeps at Prime!");
...
luckyResult; if (luckyResult == 1) {console.log("First is the worst!");
  
}

else if (luckyResult == 2) {console.log("Second is the best!");
  
}
else if (luckyResult == 3) {console.log("Third is the one with the polka dot dress!");
  
}
else {console.log("Luck is what happens when preparation meets opportunity");
...
result; if (adventurous === true) {console.log("Adventures are great!");
  
} 
else if (adventurous === false) {console.log("How about we stay home?");
  
} else {console.log("Error"); //error/exception handling etc...//
...
//Code written by Michael LaFond//
